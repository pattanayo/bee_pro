...
include 'config.php'; // config อาจจะมีการใช้ $base_url
                ...
                <tr>
                  <td>
                    <?php if (!empty($product['image'])): ?>
                      <img src="<?php echo $base_url; ?>/upload_image/<?php echo htmlspecialchars($product['image']); ?>" width="100" alt="Product Image">
                    <?php else: ?>
                  ...
                  <td>
                    ...
                    <div><small class="text-muted"><?php echo nl2br(htmlspecialchars($product['detail'])); ?></small></div>
                  </td>
                  <td><?php echo number_format($product['price'], 2); ?></td>
                  <td>
                    <a href="<?php echo $base_url; ?>/index.php?id=<?php echo $product['id']; ?>" class="btn btn-outline-dark mb-1">
